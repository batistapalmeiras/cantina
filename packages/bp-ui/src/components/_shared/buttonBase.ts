...
// Shared button vocabulary — used by both Button and IconButton so the variant
// palette, size scale and base layout live in one place.
...
export const buttonBaseCss = css<{ $fullWidth: boolean }>`
  display: inline-flex;
  align-items: center;

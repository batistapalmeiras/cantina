...
export interface SessionContextValue {
  ...
  updateOrder: (orderId: string, data: Partial<Pick<Order, 'customerName' | 'customerPhone' | 'paymentMethod' | 'tickets' | 'total' | 'stayForMeal' | 'status'>> & { receiptPath?: string | null }) => Promise<void>;
